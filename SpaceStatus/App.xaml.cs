...
namespace SpaceStatus
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            // attn MaZ: register SpaceStatusPoll
            this.registerSpaceStatusTask();
        ...
        /// MaZ attn:
        /// </summary>
        private async void registerSpaceStatusTask()
        {
            try
            {
                ...
                {
                    bool isRegistered = BackgroundTaskRegistration.AllTasks.Any(x => x.Value.Name == "StatusSpace task");
                    if (!isRegistered)
                    {
                        BackgroundTaskBuilder builder = new BackgroundTaskBuilder
                        {
                            Name = "StatusSpace task",
                            TaskEntryPoint = "SpaceStatusPoller.SpaceStatusPoll"
                        };
